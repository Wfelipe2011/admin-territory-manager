...
interface CellTerritoryImageProps {
    ...
    onImageUpload: (territoryId: string | number, file: File) => Promise<void>
}

export function CellTerritoryImage({ imageUrl, name, territoryId, onImageUpload }: CellTerritoryImageProps) {
    ...
    const handleUpload = async () => {
        ...
        try {
            setIsUploading(true)
            await onImageUpload(territoryId, selectedFile)
                    ...
                    <div className="py-4 flex flex-col items-center space-y-4">
                        ...
                        <div className="w-full">
                            ...
                            <div className="flex gap-2">
                                <Input id="image-upload" type="file" accept="image/*" onChange={handleFileChange} className="flex-1" />
                            </div>
                        </div>
                    </div>
