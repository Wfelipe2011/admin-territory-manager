      ...
      <div className="relative z-10 w-full md:w-2/3 p-8">
        <div className="w-full max-w-md mx-auto space-y-6">
          ...
          <div className="space-y-4">
            <Input type="email" placeholder="E-mail" className="h-12 px-4 rounded-md border border-gray-200" />
            <Input type="password" placeholder="Senha" className="h-12 px-4 rounded-md border border-gray-200" />
          </div>
          <Button className="w-full h-12 bg-primary hover:bg-[#69a75d] text-white rounded-full font-medium">ENTRAR</Button>
        </div>
      </div>
    </div>
  );
